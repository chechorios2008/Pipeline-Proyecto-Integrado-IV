...
-- month_no, con los números de mes del 01 al 12; 
-- month, con las primeras 3 letras 
-- de cada mes (ej. Ene, Feb); 
-- Year2016_real_time, con el tiempo promedio de 
-- entrega real por mes de 2016 (NaN si no existe); 
-- Year2017_real_time, con el 
...
-- (NaN si no existe); 
-- Year2016_estimated_time, con el tiempo promedio estimado 
-- de entrega por mes de 2016 (NaN si no existe); 
-- Year2017_estimated_time, con 
